  ...
  return (
    <>
      <motion.div
        ...
        className="w-[8px] h-[8px] bg-light-brown fixed rounded-full z-[100] pointer-events-none"
      ></motion.div>
      <motion.div
        style={{ left: smoothOuterMouse.x, top: smoothOuterMouse.y }}
        className="w-[70px] h-[70px] border-solid border-2 border-light-brown fixed rounded-full z-[100] pointer-events-none"
      ></motion.div>
    </>
  );
}
